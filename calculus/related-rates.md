...
- [Implicit Differentiation](/calculus/implicit-differentiation) — the key technique
- [Chain Rule](/calculus/chain-rule) — essential for $\frac{d}{dt}$ of functions
...
Now that you can solve related rates problems, you're ready for [Optimization](/calculus/optimization), where you'll use derivatives to find maximum and minimum values in real-world applications.

---

<div align="center">

[← Motion](/calculus/motion) | [Optimization →](/calculus/optimization)
