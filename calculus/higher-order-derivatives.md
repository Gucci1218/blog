...
- All differentiation rules: [Power](/calculus/basic-derivative-rules), [Product](/calculus/product-rule), [Quotient](/calculus/quotient-rule), [Chain](/calculus/chain-rule)
- [Trig Derivatives](/calculus/derivatives-trig)
- [Exponential](/calculus/derivatives-exp) and [Log Derivatives](/calculus/derivatives-log)
...
Congratulations! You've completed **Unit 3: Advanced Derivatives**. You now have all the differentiation tools needed for calculus. Next up is **Unit 4: Applications of Derivatives**, starting with [Motion](/calculus/motion) where you'll apply derivatives to real-world problems involving position, velocity, and acceleration.

---

<div align="center">

[← Log Derivatives](/calculus/derivatives-log) | [Unit 4: Motion →](/calculus/motion)
