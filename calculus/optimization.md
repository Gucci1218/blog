...
- [Higher-Order Derivatives](/calculus/higher-order-derivatives) — Second Derivative Test
...
With optimization mastered, you're ready for [Mean Value Theorem](/calculus/mean-value-theorem), one of the most important theoretical results in calculus that connects average rate of change to instantaneous rate of change.

---

<div align="center">

[← Related Rates](/calculus/related-rates) | [Mean Value Theorem →](/calculus/mean-value-theorem)
